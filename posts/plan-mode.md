...
<figure class="not-prose my-18 flex flex-col sm:flex-row gap-4 items-center sm:items-end">
  <img
    ...
    alt="Plan Mode cover art"
    width="360"
    height="360"
  />
  <div class="w-full min-w-0">
    <p class="mb-2 text-sm text-stone-400">Plan Mode - fire00f1y</p>
...
Thanks to [Bryan Davis](https://github.com/fire00f1y) for putting it together.
